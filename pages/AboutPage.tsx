...
export const AboutPage: React.FC = () => {
  ...
  const leaders = [
    { 
        ...
        image: "/tim-goltz.jpg" // Ensure this image is in your public folder
    },
    { 
        name: "Simon Scott", 
        role: "Director", 
    ...
    { 
        ...
        image: "/michele-deryan.jpg" // Ensure this image is in your public folder
    }
  ];
                    ...
                    >
                        <div className="w-16 h-16 rounded-2xl bg-white/5 border border-white/5 flex items-center justify-center mb-8 group-hover:bg-white/10 transition-all duration-500">
                            ...
                            <div className="text-white/60 group-hover:text-white transition-colors">
                                <WhatWeDoIcon type={item.id as any} />
                            </div>
                        </div>
