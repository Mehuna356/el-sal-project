...
const cards = [
  {
    ...
    description: "Produces an estimated 7-9M liters of domestic diesel annually. Improves Balance of Payments by keeping USD circulating within the local economy rather than exiting to foreign oil producers.",
    icon: Coins,
