                        ...
                        {menuItems.map((item) => {
                                 ...
                                 return (
                                     <div key={item.label} className="flex flex-col">
                                         <button 
                                            ...
                                            className={`text-2xl font-display font-bold text-left flex items-center justify-between ${isActive ? 'text-emerald-400' : 'text-white/80'}`}
                                         >
                                                 ...
                                                 >
                                                     {item.children.map(child => (
                                                         <button
                                                            ...
                                                            className={`text-lg font-medium text-left flex items-center gap-2 ${location.pathname === child.href ? 'text-emerald-400' : 'text-white/60'}`}
                                                         >
                                                             {child.label}
                                                         </button>
                                                     ))}
                             ...
                             return (
                                <button 
                                    ...
                                    className={`text-2xl font-display font-bold text-left flex items-center gap-3 ${isActive ? 'text-emerald-400' : 'text-white/80'}`}
                                >
                                    <item.icon className="w-6 h-6" />
                                    {item.label}
                                </button>
